...
from examples.poison.evaluation.constants import PROMPT_INPUT
from examples.poison.evaluation.utils import calculate_binary_classification_metrics, resize_tokenizer_embedding
...
class Moderation(nn.Module):
    ...
    def from_pretrained(
        ...
        device: torch.device | str | int | None = None,
        cache_dir: str | None = None,  # New parameter
    ) -> Moderation:
        """Initialize the moderation model."""
        ...
        model_kwargs['cache_dir'] ="../../cache" if cache_dir is None else cache_dir
